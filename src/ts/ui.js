            ...
            catcher.on('touchstart mousedown', function (e) {
                ...
                if (element.data('resizing') !== true) {
                    ...
                    var moveElement = function (e) {
                        ...
                        if (mouse_1.y < boundaries.top + elementDistance_1.y && elementHeight < parentHeight) {
                            newOffset.top = boundaries.top;
                        }
                        if (mouse_1.y > boundaries.bottom + elementDistance_1.y && elementHeight < parentHeight) {

export const embed = {
    ...
    run: function (instance) {
        return {
            ...
            '<embedder file-format="\'video\'" hidden-share-video-code=' + instance.hiddenShareVideoCode + ' ng-model="display.htmlCode" on-change="applyHtml()" show="display.copyEmbed"></embedder>',

...
exports.sniplet = ng_start_1.ng.directive('sniplet', function ($parse, $timeout) {
    return {
        restrict: 'E',
        scope: true,
...
exports.snipletSource = ng_start_1.ng.directive('snipletSource', function ($parse, $timeout) {
    return {
        restrict: 'E',
        scope: true,

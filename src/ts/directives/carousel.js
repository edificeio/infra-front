...
exports.carousel = ng_start_1.ng.directive('carousel', function () {
    return {
        scope: {
            items: '='
        },
        restrict: 'E',
        templateUrl: '/' + globals_1.appPrefix + '/public/template/entcore/carousel.html',
        link: function (scope, element, attributes) {
            ...
            scope.images = scope.items.filter(function (item) {
